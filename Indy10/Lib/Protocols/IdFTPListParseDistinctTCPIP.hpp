...
// (DO NOT EDIT: machine generated header) 'Idftplistparsedistincttcpip.pas' rev: 20.00
...
public:
	/* TIdDOSBaseFTPListItem.Create */ inline __fastcall virtual TIdDistinctTCPIPFTPListItem(Classes::TCollection* AOwner) : Idftplisttypes::TIdDOSBaseFTPListItem(AOwner) { }
