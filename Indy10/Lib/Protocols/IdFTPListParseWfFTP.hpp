...
// (DO NOT EDIT: machine generated header) 'Idftplistparsewfftp.pas' rev: 20.00
...
public:
	/* TIdFTPListItem.Create */ inline __fastcall virtual TIdWfFTPFTPListItem(Classes::TCollection* AOwner) : Idftplisttypes::TIdOwnerFTPListItem(AOwner) { }
