...
// (DO NOT EDIT: machine generated header) 'Dclindycore130.pas' rev: 20.00

#ifndef Dclindycore130HPP
#define Dclindycore130HPP
...
#include <Idaboutvcl.hpp>	// Pascal unit
#include <Idantifreeze.hpp>	// Pascal unit
#include <Idcoredsnregister.hpp>	// Pascal unit
#include <Idcoreselectioneditors.hpp>	// Pascal unit
#include <Iddsncoreresourcestrings.hpp>	// Pascal unit
#include <Iddsnpropedbindingvcl.hpp>	// Pascal unit
#include <Idregistercore.hpp>	// Pascal unit
...
namespace Dclindycore130
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------

}	/* namespace Dclindycore130 */
using namespace Dclindycore130;
#pragma pack(pop)
#pragma option pop

#pragma delphiheader end.
//-- end unit ----------------------------------------------------------------
#endif	// Dclindycore130HPP
